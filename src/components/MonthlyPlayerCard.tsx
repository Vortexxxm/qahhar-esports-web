...
const MonthlyPlayerCard = ({ 
  ...
  return (
    <div className="relative group mb-8 w-full max-w-lg mx-auto">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-700 via-blue-800 to-cyan-800 border-4 border-purple-300 shadow-2xl transform hover:scale-105 transition-all duration-700">
        ...
        {/* Crown and Monthly Badge */}
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-4 z-30">
          <div className="bg-gradient-to-r from-purple-400 via-blue-500 to-cyan-500 rounded-full p-4 shadow-2xl border-4 border-purple-200 animate-bounce">
            <Gem className="h-10 w-10 text-purple-900" />
          </div>
        </div>

        {/* Top Badge */}
        <div className="absolute top-8 left-1/2 transform -translate-x-1/2 z-20">
          <Badge className="bg-gradient-to-r from-purple-200 via-blue-200 to-cyan-200 text-purple-900 font-bold text-base px-6 py-3 shadow-lg border-2 border-purple-300 animate-pulse">
        ...
        {/* Header */}
        <div className="relative pt-20 pb-8 px-8 text-center bg-gradient-to-b from-purple-600/30 via-blue-600/20 to-transparent">
          <div className="relative">
            ...
            <div className="relative mx-auto mb-6">
              ...
              <Avatar className="relative w-32 h-32 border-6 border-purple-200 shadow-2xl mx-auto">
                <AvatarImage src={player.avatar_url || ""} />
                <AvatarFallback className="bg-gradient-to-br from-purple-500 via-blue-600 to-cyan-600 text-purple-100 text-4xl font-bold">
              ...
              <div className="absolute -inset-2 rounded-full">
                <Shield className="absolute top-2 left-1/4 w-7 h-7 text-purple-300 animate-bounce" />
                <Award className="absolute top-1/4 right-2 w-6 h-6 text-blue-300 animate-pulse delay-300" />
                <Star className="absolute bottom-1/4 left-2 w-6 h-6 text-cyan-300 animate-bounce delay-500" />
                <Gem className="absolute bottom-2 right-1/4 w-7 h-7 text-purple-200 animate-ping delay-700" />
                <Sparkles className="absolute top-1/2 left-0 w-5 h-5 text-blue-200 animate-pulse delay-900" />
                <Flame className="absolute top-1/2 right-0 w-5 h-5 text-cyan-200 animate-bounce delay-1100" />
              </div>
            </div>
            
            <h3 className="text-3xl font-bold text-purple-100 mb-3 drop-shadow-2xl">
              {player.username || player.full_name}
            </h3>
            
            <Badge className="bg-gradient-to-r from-purple-300 via-blue-300 to-cyan-300 text-purple-900 font-bold text-lg px-6 py-3 shadow-xl border-2 border-purple-200">
        ...
        <div className="px-8 pb-8 space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-purple-200/20 via-blue-200/20 to-purple-200/20 backdrop-blur-sm border-2 border-purple-300/50 rounded-xl p-5 text-center group/stat hover:scale-105 transition-transform duration-300">
              <Trophy className="h-7 w-7 text-purple-200 mx-auto mb-3 group-hover/stat:animate-bounce" />
              <div className="text-3xl font-bold text-purple-100">{stats.wins}</div>
              <div className="text-sm text-purple-200 font-medium">انتصارات</div>
            </div>
            
            <div className="bg-gradient-to-br from-blue-200/20 via-cyan-200/20 to-blue-200/20 backdrop-blur-sm border-2 border-blue-300/50 rounded-xl p-5 text-center group/stat hover:scale-105 transition-transform duration-300">
              <Target className="h-7 w-7 text-blue-200 mx-auto mb-3 group-hover/stat:animate-bounce" />
              <div className="text-3xl font-bold text-blue-100">{getKDRatio(stats.kills, stats.deaths)}</div>
              <div className="text-sm text-blue-200 font-medium">K/D</div>
            </div>
          </div>

          <div className="bg-gradient-to-br from-cyan-200/20 via-purple-200/20 to-cyan-200/20 backdrop-blur-sm border-2 border-cyan-300/50 rounded-xl p-6 text-center group/stat hover:scale-105 transition-transform duration-300">
            <Gamepad2 className="h-8 w-8 text-cyan-200 mx-auto mb-3 group-hover/stat:animate-bounce" />
            <div className="text-4xl font-bold text-cyan-100">{stats.points}</div>
            <div className="text-sm text-cyan-200 font-medium">النقاط الإجمالية</div>
          </div>

          {/* Bio Section */}
          {player.bio && (
            <div className="bg-gradient-to-br from-black/40 via-purple-900/30 to-black/40 backdrop-blur-sm border-2 border-purple-400/30 rounded-xl p-5">
              <p className="text-purple-100 text-sm text-center font-medium leading-relaxed">{player.bio}</p>
            </div>
          )}
          ...
          <div className="flex justify-center pt-4">
            <Button
              ...
              } rounded-xl px-8 py-4 border-2 border-purple-400/50 hover:border-purple-300/70`}
            >
              ...
              <div className="relative flex items-center space-x-4 rtl:space-x-reverse">
                <Heart className={`h-7 w-7 transition-all duration-300 ${isLiked ? 'fill-current scale-110 text-red-300' : 'group-hover/btn:scale-110'}`} />
                <span className="font-bold text-2xl">{likesCount}</span>
      ...
      <div className="absolute -top-6 -left-6 w-10 h-10 bg-purple-400 rounded-full opacity-50 animate-bounce delay-200"></div>
      <div className="absolute -top-4 -right-8 w-8 h-8 bg-blue-400 rounded-full opacity-40 animate-ping delay-500"></div>
      <div className="absolute -bottom-6 -right-6 w-9 h-9 bg-cyan-400 rounded-full opacity-50 animate-pulse delay-800"></div>
      <div className="absolute -bottom-4 -left-8 w-7 h-7 bg-purple-500 rounded-full opacity-40 animate-bounce delay-1000"></div>
